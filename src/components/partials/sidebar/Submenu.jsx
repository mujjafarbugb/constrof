              ...
              <div>
                ...
                >
                  <span
                    className={`${
                      activeMultiMenu
                        ? " bg-slate-900  ring-4 ring-opacity-[15%] ring-black-500 dark:ring-slate-300 dark:ring-opacity-20"
                        : ""
              ...
              <NavLink to={subItem.childlink}>
                {({ isActive }) => (
                  <span
                    className={`${
                      isActive
                        ? " text-blue-400 hover:text-[#18b9f9] dark:text-white font-medium"
                        : "text-slate-600 dark:text-slate-300"
                  ...
                  >
                    <span
                      className={`${
                        isActive
                          ? " bg-[#18b9f9] ring-4 ring-opacity-[15%] ring-[#18b9f9] dark:ring-slate-300 dark:ring-opacity-20"
                          : ""
                      } h-2 w-2 rounded-full border border-slate-600 dark:border-white inline-block flex-none`}
                    ></span>
                    <span className="flex-1">{subItem.childtitle}</span>
