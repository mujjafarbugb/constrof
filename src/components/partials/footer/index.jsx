...
const Footer = ({ className = "custom-class" }) => {
  ...
  return (
    ...
    <footer className={className + " " + footerclassName()}>
      <div className="site-footer px-6 bg-white text-slate-500 dark:text-slate-300 py-4">
        <div className="grid md:grid-cols-2 p-2 grid-cols-1 md:gap-5">
          {/* <div className="text-center ltr:md:text-start rtl:md:text-right text-sm">
            COPYRIGHT &copy; 2022 ConstroPlus, All rights Reserved
          </div>
