...
const Modal = ({
  ...
  centered,
  scrollContent,
  themeClass = "bg-slate-200 dark:bg-slate-800 dark:border-b dark:border-slate-700",
  title = "Basic Modal",
  uncontrol,
  label = "Basic Modal",
  labelClass,
              ...
              <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                 ...
                 bg-white text-left align-middle shadow-xl transition-alll ${className}`}
                    >
                      <div
                        className={`relative overflow-hidden py-3 px-5  flex justify-between  ${themeClass}`}
                      >
